/*
	A simple dynamic jQuery chessboard
	Written by am @ blog tamaralex net
	No copyright on the chessboard components: feel free to copy, modify and use them.
*/
...
$( document ).ready( function() {
	...
	$( "#dropper" ).draggable( {
		...
		stop: function( event , ui ) {
			...
			console.log("dropped_stop");
		}
	} );

	$( ".target" ).droppable( {
		drop: function( event , ui ) {
			console.log("droppable enter function");
